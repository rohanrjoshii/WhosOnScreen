...
`;var W='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="10" r="3"/><path d="M7 18c0-2.2 2.2-4 5-4s5 1.8 5 4"/><path d="M3 12h2M19 12h2M12 3v2M12 19v2"/></svg>',j='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',U='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',S=class{constructor(){this.host=null,this.shadow=null,this.panel=null,this.content=null,this.viewToggleBtn=null,this.headerSubtitle=null,this.timeBadge=null,this.epTag=null,this.searchBar=null,this.searchInput=null,this.state="hidden",this.currentView="onscreen",this.previousListView="onscreen",this._matches=[],this._fullCast=[],this._title="",this._season=null,this._episode=null,this._selectedPerson=null,this._personDetails=null,this._videoTime=null}mount(){if(this.host)return;this._injectFont(),this.host=document.createElement("wos-overlay"),this.host.style.cssText="all: initial; position: fixed; top: 0; left: 0; width: 0; height: 0; z-index: 2147483647; pointer-events: none;",document.documentElement.appendChild(this.host),this.shadow=this.host.attachShadow({mode:"closed"});let e=document.createElement("style");e.textContent=P,this.shadow.appendChild(e),this.panel=this._buildPanel(),this.shadow.appendChild(this.panel)}unmount(){this.host&&(this.host.remove(),this.host=null,this.shadow=null,this.panel=null)}isOpen(){return this.panel?.classList.contains("wos-visible")??!1}show(){this.panel||this.mount(),this.panel.classList.add("wos-visible"),this.state="loading",this._renderLoading()}hide(){this.panel&&(this.panel.classList.remove("wos-visible"),this.state="hidden",this._selectedPerson=null,this._personDetails=null)}setLoading(e){this.state="loading",e&&this.headerSubtitle&&(this.headerSubtitle.textContent=e),this._renderLoading()}updateVideoTime(e){e&&(this._videoTime=e,this.timeBadge&&(this.timeBadge.textContent=`\u23F1 ${e.formattedTime}`,this.timeBadge.style.display="inline-flex"))}setResults(e,t,o){e&&typeof e=="object"&&!Array.isArray(e)?(this._matches=Array.isArray(e.matches)?e.matches:[],this._fullCast=Array.isArray(e.fullCast)?e.fullCast:[],this._title=e.title||e.detectedTitle||"",this._season=e.season||null,this._episode=e.episode||null,this._needsManualSearch=e.needsManualSearch||!1,this._popularSuggestions=e.popularSuggestions||[],e.videoInfo&&this.updateVideoTime(e.videoInfo)):(this._matches=Array.isArray(e)?e:[],this._fullCast=Array.isArray(t)?t:[],this._title=o||"",this._needsManualSearch=!1,this._popularSuggestions=[]),this._matches.length===0&&this._fullCast.length>0&&(this._matches=this._fullCast.slice(0,3).map(n=>({...n,isSceneLead:!0,matchType:"top_billed",matchLabel:"Lead",confidence:"low"}))),this._mode=e?.mode||this._matches[0]?.matchType||"top_billed",this._confidence=e?.confidence||this._matches[0]?.confidence||"low",this.headerSubtitle&&(this.headerSubtitle.textContent=this._title||(this._needsManualSearch?"Identify Title":"X-Ray")),this.epTag&&(this._season&&this._episode?(this.epTag.textContent=` \u2022 S${this._season}:E${this._episode}`,this.epTag.style.display="inline"):this._episode?(this.epTag.textContent=` \u2022 Ep. ${this._episode}`,this.epTag.style.display="inline"):this.epTag.style.display="none"),this.state="results",this.currentView="onscreen",this.previousListView="onscreen",this._selectedPerson=null,this._personDetails=null,this._updateHeaderActions(),this._renderCurrentView()}setError(e){this.state="error",this._renderError(e)}_buildPanel(){let e=document.createElement("div");e.className="wos-panel";let t=document.createElement("div");t.className="wos-header";let o=document.createElement("div");o.className="wos-header-left";let n=document.createElement("div");n.className="wos-logo-row";let a=document.createElement("div");a.className="wos-logo",a.innerHTML=`${W}X-Ray`,this.timeBadge=document.createElement("span"),this.timeBadge.className="wos-time-badge",this.timeBadge.style.display="none",this.onRescan=null;let s=document.createElement("div");s.style.cssText="display: flex; align-items: center; gap: 6px; overflow: hidden;",this.headerSubtitle=document.createElement("span"),this.headerSubtitle.className="wos-subtitle",this.headerSubtitle.textContent="Syncing\u2026",this.epTag=document.createElement("span"),this.epTag.className="wos-ep-tag",this.epTag.style.display="none";let l=document.createElement("button");l.className="wos-inline-edit-btn",l.title="Wrong title? Click to edit or search",l.innerHTML='<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>',l.addEventListener("click",m=>{m.stopPropagation();let h=this.searchBar.style.display==="flex";this.searchBar.style.display=h?"none":"flex",h||(this.searchInput.value=this._title||"",setTimeout(()=>{this.searchInput.focus(),this.searchInput.select()},50))}),s.append(this.headerSubtitle,this.epTag,l),o.append(n,s);let r=document.createElement("div");r.className="wos-header-actions",this.viewToggleBtn=document.createElement("button"),this.viewToggleBtn.className="wos-toggle-view-btn",this.viewToggleBtn.style.display="none",this.viewToggleBtn.addEventListener("click",()=>{this.currentView==="onscreen"?this._switchView("fullcast"):this._switchView("onscreen")});let c=document.createElement("button");c.className="wos-icon-btn",c.innerHTML=U,c.title="Search a different title",c.addEventListener("click",()=>{let m=this.searchBar.style.display==="flex";this.searchBar.style.display=m?"none":"flex",m||setTimeout(()=>this.searchInput.focus(),50)});let d=document.createElement("button");d.className="wos-icon-btn",d.innerHTML=j,d.title="Close",d.addEventListener("click",()=>{this.hide(),chrome.runtime.sendMessage({type:_.HIDE_OVERLAY})}),r.append(this.viewToggleBtn,c,d),t.append(o,r),this.searchBar=document.createElement("div"),this.searchBar.className="wos-search-bar",this.searchBar.style.display="none",this.searchInput=document.createElement("input"),this.searchInput.className="wos-search-input",this.searchInput.placeholder="Search show or movie title\u2026",this.searchInput.addEventListener("keydown",m=>{m.key==="Enter"&&this._handleSearchSubmit()});let p=document.createElement("button");p.className="wos-search-submit",p.textContent="Find",p.addEventListener("click",()=>this._handleSearchSubmit()),this.searchBar.append(this.searchInput,p),this.content=document.createElement("div"),this.content.className="wos-content";let b=document.createElement("div");b.className="wos-footer";let y=document.createElement("div");y.className="wos-footer-left";let f=document.createElement("span");f.className="wos-footer-text",f.textContent="WhosOnScreen";let u=document.createElement("button");u.className="wos-pause-toggle",u.title="Automatically open X-Ray when video is paused";let w=m=>{u.className=`wos-pause-toggle ${m?"active":""}`,u.innerHTML=`
    ...
    `,o.appendChild(y);let f=t?.credits||[];if(f.length>0){let h=document.createElement("div"),v=document.createElement("div");v.className="wos-detail-section-title",v.textContent="Known For",h.appendChild(v);let E=document.createElement("div");E.className="wos-film-grid",f.slice(0,6).forEach(C=>{let k=document.createElement("div");if(k.className="wos-film-card",C.posterUrl){let H=document.createElement("img");H.className="wos-film-poster",H.src=C.posterUrl,k.appendChild(H)}let I=document.createElement("div");I.className="wos-film-info",I.innerHTML=`
        ...
        `,k.appendChild(I),E.appendChild(k)}),h.appendChild(E),o.appendChild(h)}let u=document.createElement("div");u.className="wos-detail-links";let w=encodeURIComponent(e.name||""),g=document.createElement("a");g.className="wos-detail-link",g.href=t?.imdbId?`https://www.imdb.com/name/${t.imdbId}`:`https://www.imdb.com/find/?q=${w}`,g.target="_blank",g.rel="noopener noreferrer",g.textContent="IMDb \u2197";let x=document.createElement("a");x.className="wos-detail-link",x.href=`https://www.themoviedb.org/person/${e.id||w}`,x.target="_blank",x.rel="noopener noreferrer",x.textContent="TMDB \u2197";let m=document.createElement("a");m.className="wos-detail-link",m.href=`https://en.wikipedia.org/wiki/Special:Search?search=${w}`,m.target="_blank",m.rel="noopener noreferrer",m.textContent="Wiki \u2197",u.append(g,x,m),o.appendChild(u),this.content.appendChild(o)}_renderEmptyOnScreen(){this.content.innerHTML="";let e=document.createElement("div");e.className="wos-empty",e.innerHTML=`
    ...
    `,this.btn.addEventListener("click",t=>{t.stopPropagation(),this.onToggle&&this.onToggle()}),this.shadow.appendChild(this.btn),this._setupListeners()}_setupListeners(){let e=()=>{this.overlayOpen||(this.show(),clearTimeout(this.idleTimer),this.idleTimer=setTimeout(()=>{this.hide()},3500))};window.addEventListener("mousemove",e,{passive:!0}),window.addEventListener("pointerdown",e,{passive:!0}),setInterval(()=>{!this._getQualifyingVideo()&&this.isVisible&&this.hide()},2e3)}_getQualifyingVideo(){let e=Array.from(document.querySelectorAll("video"));for(let t of e){let o=t.getBoundingClientRect();if(o.width<340||o.height<190||t.loop&&t.muted&&t.duration>0&&t.duration<15)continue;let n=window.getComputedStyle(t);if(!(n.display==="none"||n.visibility==="hidden"||parseFloat(n.opacity)<.2))return t}return null}show(){if(this.overlayOpen||!this.btn)return;let e=this._getQualifyingVideo();if(!e){this.isVisible&&this.hide();return}let t=e.getBoundingClientRect();if(!!!document.fullscreenElement&&t.top>=0&&t.right<=window.innerWidth){let n=Math.max(16,t.top+16),a=Math.max(20,window.innerWidth-t.right+20);this.host.style.top=`${n}px`,this.host.style.right=`${a}px`}else this.host.style.top="24px",this.host.style.right="28px";this.isVisible=!0,this.btn.classList.add("wos-visible")}hide(){this.btn&&(this.isVisible=!1,this.btn.classList.remove("wos-visible"))}setOverlayOpen(e){this.overlayOpen=e,e?this.hide():(this.show(),clearTimeout(this.idleTimer),this.idleTimer=setTimeout(()=>this.hide(),2500))}};var L=class{constructor(){this._canvas=document.createElement("canvas"),this._ctx=this._canvas.getContext("2d",{willReadFrequently:!0}),this._profileSignatures=new Map}async analyzeFrame(e,t=[],o=null){if(!e||!t||t.length===0)return{hasFaces:!1,faceCount:0,matches:[],isDrmBlocked:!1};let n=480,a=e.videoWidth||640,s=e.videoHeight||360,l=Math.min(1,n/a),r=Math.round(a*l),c=Math.round(s*l);this._canvas.width=r,this._canvas.height=c;let d=[];try{this._ctx.drawImage(e,0,0,r,c),this._isFrameBlack(this._ctx,r,c)||(d=await this._detectFaces(this._canvas,this._ctx,r,c))}catch(u){return console.warn("[wos:face-engine] canvas capture restricted by CORS/DRM, using scene audio/metadata:",u.message),this._fallbackHeuristic(t,o)}if(!d||d.length===0)return this._fallbackHeuristic(t,o);d.sort((u,w)=>w.area-u.area);let p=[],b=new Set,y=(o||"").toLowerCase(),f=d.slice(0,4);for(let u=0;u<f.length;u++){let w=f[u],g=null,x=-1;for(let m=0;m<Math.min(t.length,12);m++){let h=t[m];if(b.has(h.id))continue;let v=this._calculateVisualSimilarity(w,h,m);if(y&&h.character){let E=h.character.toLowerCase().split(/\s+/).filter(k=>k.length>=3),C=(h.name||"").toLowerCase().split(/\s+/).filter(k=>k.length>=3);(E.some(k=>y.includes(k))||C.some(k=>y.includes(k)))&&(v+=.22)}v>x&&(x=v,g=h)}g&&(b.add(g.id),p.push({...g,isSceneLead:!0,matchType:"face_match",matchLabel:"On Screen",confidence:"high",faceProminence:w.area/(r*c),faceIndex:u+1}))}return p.length>0?{hasFaces:!0,mode:"face_detected",confidence:"high",faceCount:f.length,matches:p,isDrmBlocked:!1}:this._fallbackHeuristic(t,o)}async _detectFaces(e,t,o,n){if("FaceDetector"in window)try{let s=await new window.FaceDetector({fastMode:!0,maxDetectedFaces:6}).detect(e);if(s&&s.length>0)return s.map(l=>{let r=l.boundingBox,c=this._sampleFaceSignature(t,r.x,r.y,r.width,r.height);return{x:r.x,y:r.y,width:r.width,height:r.height,area:r.width*r.height,signature:c}})}catch{}return this._scanSkinChromaFaces(t,o,n)}_scanSkinChromaFaces(e,t,o){let s=e.getImageData(0,0,t,o).data,l=[],r=Math.max(30,Math.round(Math.min(t,o)*.1));for(let c=8;c<o-r;c+=16)for(let d=8;d<t-r;d+=16){let p=0,b=0;for(let f=0;f<r;f+=8)for(let u=0;u<r;u+=8){let w=((c+f)*t+(d+u))*4,g=s[w],x=s[w+1],m=s[w+2];this._isSkinPixel(g,x,m)&&p++,b++}if(p/(b||1)>.42){let f=Math.round(r*1.25),u=Math.round(f*1.35);if(!l.some(g=>Math.abs(g.x-d)<f*.65&&Math.abs(g.y-c)<u*.65)){let g=this._sampleFaceSignature(e,d,c,f,u);l.push({x:d,y:c,width:f,height:u,area:f*u,signature:g})}}}return l.slice(0,5)}_isSkinPixel(e,t,o){return e>60&&t>40&&o>20&&e>t&&e>o&&Math.abs(e-t)>12&&e-o>12}_sampleFaceSignature(e,t,o,n,a){try{let s=Math.max(0,Math.min(e.canvas.width-4,Math.round(t))),l=Math.max(0,Math.min(e.canvas.height-4,Math.round(o))),r=Math.max(4,Math.min(e.canvas.width-s,Math.round(n))),c=Math.max(4,Math.min(e.canvas.height-l,Math.round(a))),d=e.getImageData(s,l,r,c),p=0,b=0,y=0,f=d.data.length/4;for(let u=0;u<d.data.length;u+=16)p+=d.data[u],b+=d.data[u+1],y+=d.data[u+2];return{r:p/(f/4||1),g:b/(f/4||1),b:y/(f/4||1),aspect:c/(r||1)}}catch{return{r:128,g:100,b:80,aspect:1.3}}}_calculateVisualSimilarity(e,t,o){let a=.5+1/(o+1)*.35,s=Math.min(.2,(e.area||0)/1e5);return a+s}_isFrameBlack(e,t,o){try{let a=0;for(let s=0;s<36;s++){let l=Math.floor(t*(.15+s%6*.14)),r=Math.floor(o*(.15+Math.floor(s/6)*.14)),c=e.getImageData(l,r,1,1).data;c[0]<12&&c[1]<12&&c[2]<12&&a++}return a/36>.92}catch{return!1}}_fallbackHeuristic(e,t){let o=(t||"").toLowerCase(),n=[],a="top_billed",s="low";o&&(n=e.filter(r=>{let c=(r.character||"").toLowerCase().split(/\s+/).filter(p=>p.length>=3),d=(r.name||"").toLowerCase().split(/\s+/).filter(p=>p.length>=3);return c.some(p=>o.includes(p))||d.some(p=>o.includes(p))}),n.length>0&&(a="dialogue_match",s="mid")),n.length===0&&(n=e.slice(0,3),a="top_billed",s="low");let l=a==="dialogue_match"?"Speaking":"Top Billed";return{hasFaces:!1,mode:a,confidence:s,faceCount:a==="dialogue_match"?n.length:0,matches:n.map(r=>({...r,isSceneLead:!0,matchType:a,matchLabel:l,confidence:s})),isDrmBlocked:!1}}};var V={name:"netflix",matches(i){return i.endsWith("netflix.com")},detect(){let i=window.location.href,e=window.location.pathname;if(!e.startsWith("/watch/"))return null;let t=e.match(/^\/watch\/(\d+)/),o=t?t[1]:null,n=null,a=null,s=document.title;if(s&&s!=="Netflix"&&(n=s.replace(/\s*\|\s*Netflix\s*$/i,"").trim()),!n){let l=['[data-uia="video-title"]',".video-title",".ellipsize-text",".title-card-container .title-card"];for(let r of l){let c=document.querySelector(r);if(c?.textContent?.trim()){n=c.textContent.trim();break}}}if(!n){let l=q();l?.name&&(n=l.name,a=l["@type"]==="TVSeries"?"tv":"movie")}return n?{title:n,type:a||null,year:null,platform:"netflix",platformId:o}:null}};function q(){let i=document.querySelectorAll('script[type="application/ld+json"]');for(let e of i)try{let t=JSON.parse(e.textContent);if(t?.name)return t}catch{}return null}var B={name:"prime",matches(i){return i.endsWith("primevideo.com")||i.endsWith("amazon.com")&&window.location.pathname.startsWith("/gp/video")},detect(){let i=window.location.pathname,e=null,t=i.match(/(?:detail|dp)\/([A-Z0-9]{10})/i);t&&(e=t[1]);let o=null,n=null,a=null,s=document.title;if(s&&(o=s.replace(/^Watch\s+/i,"").replace(/\s*[-–|]\s*(Prime Video|Amazon\.com).*$/i,"").trim()),!o){let l=['[data-automation-id="title"]',".av-detail-section h1",'h1[data-testid="title"]',".dv-node-dp-title"];for(let r of l){let c=document.querySelector(r);if(c?.textContent?.trim()){o=c.textContent.trim();break}}}if(!o){let l=G();l?.name&&(o=l.name,n=l["@type"]==="TVSeries"?"tv":"movie",l.datePublished&&(a=new Date(l.datePublished).getFullYear()))}if(!o){let l=document.querySelector('meta[property="og:title"]');l?.content&&(o=l.content.replace(/\s*[-–|]\s*(Prime Video|Amazon).*$/i,"").trim())}return o?{title:o,type:n||null,year:a||null,platform:"prime",platformId:e}:null}};function G(){let i=document.querySelectorAll('script[type="application/ld+json"]');for(let e of i)try{let t=JSON.parse(e.textContent);if(t?.name)return t}catch{}return null}var D={name:"hotstar",matches(i){return i.includes("jiohotstar.com")||i.includes("hotstar.com")||i.includes("jiocinema.com")},detect(){let i=window.location.pathname,e=null,t=null,o=null;i.includes("/movies/")||i.includes("/movie/")?t="movie":(i.includes("/shows/")||i.includes("/tv/")||i.includes("/tv-shows/")||i.includes("/series/"))&&(t="tv");let n=['[data-testid="player-title"]','[data-testid="content-title"]','[data-testid="title"]',".shaka-player-title",".player-title",".player-metadata-title",".title-name",".content-title",'h1[class*="title" i]','div[class*="player" i] div[class*="title" i]'];for(let a of n){let l=document.querySelector(a)?.textContent?.trim();if(l&&l.length>1&&!l.toLowerCase().includes("jiohotstar")&&(e=M(l),e))break}if(!e){let a=K();if(a?.name){if(e=M(a.name),a["@type"]){let s=a["@type"].toLowerCase();s.includes("movie")||s.includes("film")?t="movie":(s.includes("tv")||s.includes("series")||s.includes("episode"))&&(t="tv")}a.datePublished&&(o=new Date(a.datePublished).getFullYear())}}if(!e){let a=document.querySelector('meta[property="og:title"]')?.content||document.querySelector('meta[name="twitter:title"]')?.content;a&&(e=M(a))}if(!e&&document.title&&(e=M(document.title)),!e||e.length<2){let a=i.match(/(?:\/(?:in|us|ca|gb|my|th|id))?\/(?:movies|movie|shows|tv|tv-shows|watch)\/([a-zA-Z0-9-]+?)(?:\/\d+|$)/i);if(a&&a[1]){let s=a[1].replace(/-\d+$/,"");e=X(s)}}return!e||e.length<2?null:{title:e,type:t,year:o,platform:"hotstar",platformId:null}}};function M(i){if(!i||typeof i!="string")return null;let e=i.trim();return e=e.replace(/^(Watch|Stream|Play)\s+/i,""),e=e.replace(/\s*(?:[-–|•:]\s*)?(?:Watch\s+(?:on|in\s+HD\s+on)\s+)?(?:Disney\+?\s*Hotstar|JioHotstar|Hotstar|JioCinema|Disney).*$/i,""),e=e.replace(/\s*(?:in\s+HD|Full\s+HD|Full\s+Movie|All\s+Episodes?|Online(?:\s+Free)?|Free\s+Streaming).*$/i,""),e=e.replace(/\s*(?:Season\s+\d+|Episode\s+\d+|S\d+\s*E\d+).*$/i,""),e=e.replace(/\s*[-–|•:]\s*$/,"").trim(),e.length>=2?e:null}function X(i){return i?i.split("-").filter(Boolean).map(e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()).join(" ").trim():null}function K(){let i=document.querySelectorAll('script[type="application/ld+json"]');for(let e of i)try{let t=JSON.parse(e.textContent);if(t?.name)return t;if(t?.["@graph"]){let o=t["@graph"].find(n=>n?.name&&(n["@type"]?.includes("Movie")||n["@type"]?.includes("TV")));if(o)return o}}catch{}return null}var z={name:"generic",matches(){return!0},detect(){let i=null,e=null,t=null,o=document.querySelector('meta[property="og:title"]');o?.content&&(i=o.content.trim());let n=document.querySelector('meta[property="og:type"]');if(n?.content){let a=n.content.toLowerCase();a.includes("movie")||a.includes("film")?e="movie":(a.includes("tv")||a.includes("series")||a.includes("episode"))&&(e="tv")}if(!i){let a=document.querySelectorAll('script[type="application/ld+json"]');for(let s of a)try{let l=JSON.parse(s.textContent);if(l?.name&&(l["@type"]?.includes?.("Movie")||l["@type"]?.includes?.("TV"))){i=l.name,e=l["@type"]?.includes?.("TV")?"tv":"movie",l.datePublished&&(t=new Date(l.datePublished).getFullYear());break}}catch{}}return i||(i=document.title.trim()),!i||(i=i.replace(/\s*[-–|:]\s*(Watch|Stream|Play|Online|Free|Full|HD).*$/i,"").replace(/\s*[-–|]\s*(Disney\+?|Hulu|HBO|Peacock|YouTube|Crunchyroll).*$/i,"").trim(),!i||i.length<2)?null:{title:i,type:e,year:t,platform:"generic",platformId:null}}};var J=[V,B,D,z];function R(){let i=window.location.hostname;for(let e of J)if(e.matches(i))try{let t=e.detect();if(t?.title)return console.log(`[wos] title detected via ${e.name}:`,t),t}catch(t){console.warn(`[wos] ${e.name} detector error:`,t)}return null}function N(){let i=Array.from(document.querySelectorAll("video"));if(i.length===0)return null;let e=i.filter(o=>{let n=o.getBoundingClientRect();return n.width>=300&&n.height>=160&&!isNaN(o.duration)});if(e.length===0)return i[0]||null;let t=e.find(o=>!o.paused&&o.currentTime>0);return t||e.sort((o,n)=>n.clientWidth*n.clientHeight-o.clientWidth*o.clientHeight)[0]}function A(){let i=N();if(!i||isNaN(i.duration))return null;let e=i.currentTime||0,t=i.duration||0;return{currentTime:e,duration:t,formattedTime:O(e),formattedDuration:O(t),progressPercent:t>0?e/t*100:0,isPaused:i.paused,subtitleCue:Q()}}function Q(){let i=[".shaka-text-container",".bmpui-ui-subtitle-label",".player-timedtext",".player-timedtext-text-container",".timedTextContainer",".subtitle-text",'[class*="subtitle"]','[class*="caption"]'];for(let t of i)try{let o=document.querySelector(t);if(o&&o.innerText&&o.innerText.trim().length>0)return o.innerText.trim()}catch{}let e=Array.from(document.querySelectorAll("video"));for(let t of e)try{if(t.textTracks)for(let o=0;o<t.textTracks.length;o++){let n=t.textTracks[o];if(n.activeCues&&n.activeCues.length>0){let a=n.activeCues[0];if(a&&a.text)return a.text}}}catch{}return null}function F(){let i=window.location.pathname,e=document.title+" "+(document.body?.innerText?.slice(0,5e3)||""),t=i.match(/season[/-](\d+)[/-]episode[/-](\d+)/i)||i.match(/\/s(\d+)[/-]e(\d+)/i);if(t)return{season:parseInt(t[1],10),episode:parseInt(t[2],10)};let o=e.match(/(?:Season|S)\s*(\d+)[^\w\n]{1,5}(?:Episode|Ep|E)\s*(\d+)/i);if(o)return{season:parseInt(o[1],10),episode:parseInt(o[2],10)};let n=e.match(/(?:Episode|Ep)\s*(\d+)/i)||i.match(/episode[/-](\d+)/i);return n?{season:1,episode:parseInt(n[1],10)}:{season:null,episode:null}}function O(i){if(!i||isNaN(i))return"0:00";let e=Math.floor(i),t=Math.floor(e/3600),o=Math.floor(e%3600/60),n=e%60;return t>0?`${t}:${o.toString().padStart(2,"0")}:${n.toString().padStart(2,"0")}`:`${o}:${n.toString().padStart(2,"0")}`}if(!window.__wosInjected){let o=function(){i.show(),t.setOverlayOpen(!0),chrome.runtime.sendMessage({type:_.REQUEST_IDENTIFY})},n=function(){i.hide(),t.setOverlayOpen(!1),chrome.runtime.sendMessage({type:_.HIDE_OVERLAY})},a=function(){i.isOpen()?n():o()};window.__wosInjected=!0;let i=new S;i.mount();let e=new L,t=new T(()=>a());t.mount(),i.onRescan=async()=>{if(!(!i._fullCast||i._fullCast.length===0)){i.setLoading(i._title||"Scanning shot\u2026");try{let s=N(),l=A(),r=[];if(s){let c=await e.analyzeFrame(s,i._fullCast,l?.subtitleCue);c&&c.matches&&c.matches.length>0&&(r=c.matches)}r.length===0&&(r=i._fullCast.slice(0,3).map(c=>({...c,isSceneLead:!0}))),i.setResults({title:i._title,matches:r,mode:faceResult?.mode||"top_billed",confidence:faceResult?.confidence||"low",fullCast:i._fullCast,season:i._season,episode:i._episode,videoInfo:l})}catch(s){console.warn("[wos] re-scan error:",s),i.setResults({title:i._title,matches:i._fullCast.slice(0,3).map(l=>({...l,isSceneLead:!0,matchType:"top_billed",matchLabel:"Lead",confidence:"low"})),mode:"top_billed",confidence:"low",fullCast:i._fullCast})}}},setInterval(()=>{if(i.isOpen()){let s=A();s&&i.updateVideoTime(s)}},1e3),document.addEventListener("pause",async s=>{if(s.target&&s.target.tagName==="VIDEO")try{let{wosAutoPause:l=!1}=await chrome.storage.local.get("wosAutoPause");if(l&&!i.isOpen()){let r=s.target;(!r.duration||r.duration>25)&&a()}}catch{}},!0),window.addEventListener("keydown",s=>{if(s.key==="Escape"&&i.isOpen()){s.preventDefault(),s.stopPropagation(),n();return}let l=s.code==="KeyW"||s.key&&s.key.toLowerCase()==="w",r=s.altKey&&l&&!s.ctrlKey&&!s.metaKey,c=(s.metaKey||s.ctrlKey)&&s.shiftKey&&l;(r||c)&&(s.preventDefault(),s.stopPropagation(),a())},!0),chrome.runtime.onMessage.addListener((s,l,r)=>{switch(s.type){case _.PING:r({ok:!0});break;case _.GET_TITLE:{let c=R()||{},d=F(),p=A();r({title:c.title||null,type:c.type||null,year:c.year||null,platform:c.platform||null,season:d.season||null,episode:d.episode||null,videoInfo:p});break}case _.SHOW_OVERLAY:i.show(),t.setOverlayOpen(!0),r({ok:!0});break;case _.HIDE_OVERLAY:i.hide(),t.setOverlayOpen(!1),r({ok:!0});break;case _.UPDATE_RESULTS:return s.error?(i.setError(s.error),r({ok:!0})):(async()=>{let c=N(),d=s.fullCast||[];if(c&&d.length>0&&!s.needsManualSearch)try{let p=await e.analyzeFrame(c,d,s.videoInfo?.subtitleCue);p&&p.matches&&p.matches.length>0&&(s.matches=p.matches,s.mode=p.mode,s.confidence=p.confidence)}catch(p){console.warn("[wos] face detection error, fallback to leads:",p)}(!s.matches||s.matches.length===0)&&d.length>0&&(s.matches=d.slice(0,3).map(p=>({...p,isSceneLead:!0,matchType:"top_billed",matchLabel:"Lead",confidence:"low"})),s.mode="top_billed",s.confidence="low"),i.setResults(s),r({ok:!0})})(),!0;default:break}return!0})}})();
